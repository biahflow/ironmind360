...
const INACTIVE_STROKE = "#252830";
const PRIMARY_STROKE = "#F26B4D";
const SECONDARY_STROKE = "#A03020";
const SKIN_STROKE = "#2a2d36";
...
const FRONT_MUSCLES: Record<string, string> = {
  ...
  // ── Abductors (tensor fasciae latae region) ──
  abductors_L:
...
// Map muscle group keys to their SVG path keys (some have L/R variants)
